...
On this machine, use the configured draw.io Desktop CLI first:

```
"E:\draw.io\draw.io.exe"
```

Verify that exact path before searching other locations. If it exists, use it
for opening `.drawio` files and for all PNG/SVG/PDF export commands.
