---
name: aicoding-architecture-first-scaffolding
description: Build architecture skeletons, module boundaries, interface contracts, stubs, mocks, build wiring, and smoke tests before adding full implementation logic.
---
...
Use this skill after SDD, MVP, and BDD, but before concrete implementation.

## Principle

Do not write deep business logic before the architecture skeleton is visible and validated.

## Required scaffolding artifacts
...
- test harness;
- minimal smoke test;
- architecture notes in SDD/PDR/ADR.

## Validation gate

Before filling real logic, confirm:

- the project builds or at least the new skeleton compiles;
- public interfaces are coherent;
- dependency direction does not violate architecture;
- test harness can run;
- basic smoke path works;
- documentation has been updated.

For embedded projects, also verify linker impact, memory map assumptions, startup path, vector table implications, ISR constraints, and hardware binding boundaries when relevant.

Use `references/aicoding-sdd-bdd-docsync/architecture-scaffolding-template.md`.
