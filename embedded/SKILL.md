...
- `git-skill`（路径 `embedded/git/`）：嵌入式优先、可通用的 Git、GitHub、分支、提交、PR、合并、Tag、Release、README、CHANGELOG、版本文件、固件制品、测试基线、生产基线和客户交付治理。
...
- Git、GitHub、发布、版本、README 或 CHANGELOG 治理任务以 `git-skill` 为主；如果同时修改 C 代码，再按实现/评审需要补充 `c99` 或 `review`。
